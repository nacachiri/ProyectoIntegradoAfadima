 ...
 */
class getNumerariosRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NumerariosRepository' shared autowired service.
     *
     * @return \App\Repository\NumerariosRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NumerariosRepository.php';

        return $container->privates['App\\Repository\\NumerariosRepository'] = new \App\Repository\NumerariosRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
