...
class getProductosRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProductosRepository.php';

        return $container->privates['App\\Repository\\ProductosRepository'] = new \App\Repository\ProductosRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
