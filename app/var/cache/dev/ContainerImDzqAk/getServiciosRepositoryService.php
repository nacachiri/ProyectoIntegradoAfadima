 ...
 */
class getServiciosRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ServiciosRepository' shared autowired service.
     *
     * @return \App\Repository\ServiciosRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiciosRepository.php';

        return $container->privates['App\\Repository\\ServiciosRepository'] = new \App\Repository\ServiciosRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
