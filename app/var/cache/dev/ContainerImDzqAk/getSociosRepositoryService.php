 ...
 */
class getSociosRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SociosRepository' shared autowired service.
     *
     * @return \App\Repository\SociosRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SociosRepository.php';

        return $container->privates['App\\Repository\\SociosRepository'] = new \App\Repository\SociosRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
