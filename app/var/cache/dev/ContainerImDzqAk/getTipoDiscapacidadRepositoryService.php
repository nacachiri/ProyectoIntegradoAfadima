 ...
 */
class getTipoDiscapacidadRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TipoDiscapacidadRepository' shared autowired service.
     *
     * @return \App\Repository\TipoDiscapacidadRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TipoDiscapacidadRepository.php';

        return $container->privates['App\\Repository\\TipoDiscapacidadRepository'] = new \App\Repository\TipoDiscapacidadRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
